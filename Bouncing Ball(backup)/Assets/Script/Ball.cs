...
public class Ball : MonoBehaviour
{
    ...
    {
        if(ScoreManager.instance.HighScore[StageManager.instance.ChapterNum - 1, StageManager.instance.StageNum-1] < score)
        {
            ScoreManager.instance.HighScore[StageManager.instance.ChapterNum - 1, StageManager.instance.StageNum-1] = score;
            PlayerPrefs.SetInt("HighScore_"+ StageManager.instance.ChapterNum + "_" + StageManager.instance.StageNum, ScoreManager.instance.HighScore[StageManager.instance.ChapterNum - 1, StageManager.instance.StageNum-1]);            
        }
    }
}
